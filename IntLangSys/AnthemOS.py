...
def Main(FileName):
    linenumber = 1
    mainfileName = 'Programs/' + FileName + '.txt'
        ...
        while line != "":
            ...
            if line != []:
                if line[0] == "assign":
                    ...
                    ifCount += 1
                    ifList = []
                    while (line[0] != "continue" or line[0] != "elseif" or line[0] != "else") and ifCount == 1:
                        ...
                        linenumber += 1
                        storedLine = f.readline()
                        line = storedLine.lower()
                        line = line.split()

                    IfElseDictIn[currentCount] = ifList
                    
                    while (line[0] != "continue" or line[0] != "else") and ifCount == 1:
                    ...
                    if line[0] == "else" and ifCount == 1:
                        ...
                        ifList = []
                        IfElseDictCore[currentCount] = storedLine
                        while line[0] != "continue" and ifCount == 1:
                            if line[0] == "if" and ifCount > 0:
                                ifCount += 1
                            elif line[0] == "continue" and ifCount > 0:
                                ifCOunt -= 1
                    ...
                    elif line[0] == "continue" and ifCount == 1:
                        ifCount -= 1
    ...
    except ZeroDivisionError: #REMOVE THIS AFTER DEBUG IS COMPLETE!! (ZeroDivisionError)
        p = 5
        
MemReg.MemStart()
program = 'defaultprogram'
program = input("Enter file name: ")
Main(program)
